...
class DetalhaIncluiAcao extends StatefulWidget {
  ...
  const DetalhaIncluiAcao({Key key, @required this.symbol, @required this.name,}) : super(key: key);
}
      ...
      return Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('$price', style: TextStyle(color: Colors.black, fontSize: 18.0)),
                  ),
